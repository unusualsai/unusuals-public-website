...
export var datoToContentfulMarks = (_a = {},
    _a[MARKS.BOLD] = 'strong',
    _a[MARKS.ITALIC] = 'emphasis',
    _a[MARKS.UNDERLINE] = 'underline',
    _a[MARKS.CODE] = 'code',
    _a);
export function richTextToStructuredText(tree, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, visitNode(createNode, tree, {
                            parentNodeType: 'root',
                            parentNode: null,
