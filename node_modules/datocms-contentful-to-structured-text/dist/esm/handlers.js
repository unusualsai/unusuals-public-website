            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (children.some(function (child) {
                        return child && !allowedChildren.root.includes(child.type);
                    })) {
        ...
        return __generator(this, function (_a) {
            ...
            if (Array.isArray(node.marks) && node.marks.length > 0) {
                allowedMarks = node.marks
                    ...
                    return context.allowedMarks.includes(datoToContentfulMarks[mark]);
                });
                if (allowedMarks.length > 0) {
                    marks.marks = allowedMarks.map(function (m) { return datoToContentfulMarks[m]; });
                }
            }
                ...
                case 1:
                    ...
                    if (Array.isArray(children) && children.length) {
                        ...
                        if (children.length === 1 &&
                            ...
                            return [2 /*return*/, codeBlock(createNode, children[0])];
                        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, visitChildren(createNode, node, __assign(__assign({}, context), { parentNodeType: isAllowedChild ? 'heading' : context.parentNodeType }))];
                case 1:
                    children = _a.sent();
                    if (Array.isArray(children) && children.length) {
...
export var codeBlock = function codeBlock(createNode, node) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export var handlers = (_a = {
        text: span
    },
    _a[BLOCKS.DOCUMENT] = root,
    _a[BLOCKS.PARAGRAPH] = paragraph,
    _a[BLOCKS.HEADING_1] = heading,
    _a[BLOCKS.HEADING_2] = heading,
    _a[BLOCKS.HEADING_3] = heading,
    _a[BLOCKS.HEADING_4] = heading,
    _a[BLOCKS.HEADING_5] = heading,
    _a[BLOCKS.HEADING_6] = heading,
    _a[BLOCKS.UL_LIST] = list,
    _a[BLOCKS.OL_LIST] = list,
    _a[BLOCKS.LIST_ITEM] = listItem,
    _a[BLOCKS.QUOTE] = blockquote,
    _a[BLOCKS.HR] = thematicBreak,
    _a[INLINES.HYPERLINK] = link,
    _a[INLINES.EMBEDDED_ENTRY] = noop,
    _a[BLOCKS.EMBEDDED_ASSET] = noop,
    _a[BLOCKS.EMBEDDED_ENTRY] = noop,
    _a[INLINES.ASSET_HYPERLINK] = noop,
    _a[INLINES.ENTRY_HYPERLINK] = noop,
    _a);
