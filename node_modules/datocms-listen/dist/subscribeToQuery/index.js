...
function subscribeToQuery(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    query = options.query, token = options.token, variables = options.variables, preview = options.preview, environment = options.environment, customFetcher = options.fetcher, customEventSourceClass = options.eventSourceClass, onStatusChange = options.onStatusChange, onUpdate = options.onUpdate, onChannelError = options.onChannelError, customReconnectionPeriod = options.reconnectionPeriod, customBaseUrl = options.baseUrl;
                ...
                case 5: return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        eventSource.onerror = function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                eventSource.close();
                                if (!stopReconnecting) {
                                    waitAndReconnect();
