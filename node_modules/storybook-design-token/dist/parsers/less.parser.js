...
var LessParser = /** @class */ (function () {
    function LessParser() {
    }
    LessParser.prototype.parse = function (tokenFiles) {
    ...
    LessParser.prototype.mapTokenFilesToHardCodedValues = function (tokenFiles, tokenGroups) {
        var _this = this;
        if (!tokenFiles.less) {
            return [];
        }
        ...
        tokenFiles.less.forEach(function (tokenFile) {
            var parsed = gonzales.parse(tokenFile.content, { syntax: 'less' });
    ...
    LessParser.prototype.mapTokenFilesToKeyframes = function (tokenFiles) {
    ...
    LessParser.prototype.mapTokenFilesToTokenGroups = function (tokenFiles) {
        var _this = this;
        if (!tokenFiles || !tokenFiles.less) {
            return [];
        }
        var parsedTokenFiles = tokenFiles.less.map(function (tokenFile) {
            return gonzales.parse(tokenFile.content, { syntax: 'less' });
        });
    ...
    LessParser.prototype.mapTokenGroup = function (item, nextItem, parsedTokenFile, parsedTokenFiles) {
    ...
    LessParser.prototype.addTokensToTokenGroup = function (tokenGroup, parsedTokenFile, parsedTokenFiles) {
        var _this = this;
    ...
    LessParser.prototype.mapPropertyValue = function (value) {
        return this.reducePropertyValues(value);
    };
    LessParser.prototype.reducePropertyValues = function (value, reduced) {
        var _this = this;
    ...
    LessParser.prototype.addValueUnit = function (value, type) {
        if (type === 'color') {
            return "#" + value;
        }
        if (type === 'percentage') {
    ...
    LessParser.prototype.parseCommentBlock = function (string) {
