...
export declare class LessParser implements Parser {
    parse(tokenFiles: TokenFiles): {
        hardCodedValues: HardCodedValues[];
        tokenGroups: TokenGroup[];
        keyframes: string;
    };
    private mapTokenFilesToHardCodedValues;
    private mapTokenFilesToKeyframes;
    private mapTokenFilesToTokenGroups;
    private mapTokenGroup;
    private addTokensToTokenGroup;
    private mapPropertyValue;
    private reducePropertyValues;
    private addValueUnit;
