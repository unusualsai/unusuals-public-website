      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            spinner = (0, _ora["default"])("Promoting environment `".concat(environmentId, "` to primary environment\n")).start();
          ...
          case 7:
            spinner.succeed("`".concat(environmentId, "` is now the primary environment"));
            _context.next = 14;
            break;
