...
function _dump() {
  _dump = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(configFile, itemsRepo) {
    var quiet,
        destinationPath,
        config,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            quiet = _args.length > 2 && _args[2] !== undefined ? _args[2] : false;
            destinationPath = _args.length > 3 && _args[3] !== undefined ? _args[3] : process.cwd();
            ...
            _i18n$availableLocale = _slicedToArray(_i18n["default"].availableLocales, 1);
            _i18n["default"].locale = _i18n$availableLocale[0];
            startOperation = start(destinationPath, config.bind(config, itemsRepo));
