...
function _articles() {
  _articles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dato, wp, schema, media, categories, tags, authors) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0, _allPages["default"])('Fetching articles', wp.posts());
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      _context2.next = 6;
                      return tick(article.title.rendered, createAndPublish());
